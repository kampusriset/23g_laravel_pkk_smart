...
<!-- Page Wrapper -->
          ...
          <nav class="navbar navbar-dark bg-primary ">
              <div class="container">
                ...
                <a class="navbar-brand" href="/resident">
                    <div class="navbar-brand mx-3 ">PKK SMART</div>
                </a>
                <div class="navbar-heading text-white">
                    Manajemen Agenda Pkk
                </div>
                <!-- Nav Item - Dashboard -->
                <div class="nav-item" >
    ...
    <div class="sidebar desktop-only">
      <div class="sidebar__logo">
        ...
        <span class="sidebar__title">Kalendar</span>
      </div>

      <button class="button button--primary button--lg" data-event-create-button>Tambah Kegiatan</button>
      ...
      <div class="nav">
        ...
        <div class="nav__date-info">
          <div class="nav__controls">
            <button class="button button--secondary desktop-only" data-nav-today-button>Hari Ini</button>
  ...
  <template data-template="mini-calendar-day-list-item">
    ...
    <script src="{{ asset('templat/vendor/jquery/jquery.min.js') }}"></script>
